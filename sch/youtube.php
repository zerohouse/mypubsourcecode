...
class ApiManager {
        ...
        private $key = ""; // 사용자가 발급받은 오픈API 키 
        private $searchUrl = "http://gdata.youtube.com/feeds/api/videos?max-results=3"; // 오픈API 호출URL
        private $target = "";
        ...
        {
                $url = sprintf("%s&q=%s", $this->searchUrl, $query);
